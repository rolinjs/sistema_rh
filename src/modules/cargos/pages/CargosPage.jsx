...
function CargosPage() {
    ...
    const cargos = [
        ...
        },
        {
            ...
            descripcion: 'Responsable de las operaciones de planta.',
            estado: true
        },
        {
            id: 3,
            codigo: 'SUP',
            nombre: 'Supervisor',
            descripcion: 'Supervisión de las operaciones productivas.',
            estado: true
        },
        {
            id: 4,
            ...
            descripcion: 'Responsable de actividades administrativas.',
            estado: true
        },
        {
            id: 5,
            codigo: 'OPR',
            nombre: 'Operario',
            descripcion: 'Personal encargado de las operaciones.',
            estado: true
        }
    ]
